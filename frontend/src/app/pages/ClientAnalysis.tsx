...
export default function ClientAnalysis() {
  ...
  // 1. Initial Simulation (Runs as soon as the page opens)
  useEffect(() => {
    if (clientId) {
      // Here you can trigger a default simulation for the selected ID
    ...
    <div className="min-h-screen bg-bank-bg animate-in fade-in duration-500">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-black text-foreground">Profile Analysis: {clientId}</h1>
            ...
            <div className="flex items-center gap-2 bg-green-50 text-green-700 px-4 py-2 rounded-xl border border-green-100">
              ...
              <span className="text-xs font-bold uppercase tracking-wider">Open Finance Active</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="grid grid-cols-12 gap-8">
          ...
          {/* LEFT COLUMN: Manager Controls (UserForm) */}
          ...
          <div className="col-span-8">
            {isLoading ? (
              <div className="h-[500px] flex flex-col items-center justify-center bg-white rounded-[32px] border border-dashed border-slate-300">
                ...
                <p className="text-muted-foreground font-medium italic">Running 10,000 paths in C++...</p>
              </div>
            ) : simulationResults ? (
